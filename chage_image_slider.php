  ...
  <body class="a bg-light">
    <div class="container-fluid ">
      <div class="row p-3" style="border-bottom: 3px solid black; background-color: #0f3460">
        ...
        <div class="col-md-9 ">
          <h3 class=""><a class="text-info" style="text-decoration: none; float: right; font-size: 30px;" href="dashboard.php"><b>Health Care Center Slider Manager </b></a></h3>
        </div>
      </div>
    </div><!-- Nav Bar End -->

    <h3 class=""><a class="text-info ml-5" style="text-decoration: none; float: left; font-size: 30px;" href="chage_image_slider.php"><b>Change Images Slider </b></a></h3>
  <div id="content"><br>
