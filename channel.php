      ...
      <?php 
        while($row = mysqli_fetch_assoc($viewresult))
        {
          ...
          <div class="row" style="background-color: #0f3460; color: white; margin: 1%; padding: 1%; border-radius: 1em; text-align: center;">
            <div class="col-md-2">
              <h4 style="color: yellow;">Doctor Name</h4>
              <h4><?php echo $doctname; ?></h4>
            </div>
            <div class="col-md-2">
            ...
            <div class="col-md-2">
              <h4 style="color: yellow;">Room Number</h4>
              <h4><?php echo $row['roomNo']; ?></h4>
            </div>
            <div class="col-md-2">
              <h4 style="color: yellow;">Date</h4>
              <h4><?php echo $row['sc_date']; ?></h4>
            </div>
            <div class="col-md-1">
              <h4 style="color: yellow;">Time</h4>
              <h4><?php echo $row['sc_time']; ?></h4>
            </div>
            <div class="col-md-2">
            ...
            <div class="col-md-2 mt-5">
              <form method="POST" action="">
                <button type="button" name="submit" onclick="window.location.href='appinment.php?sch_id=<?php echo $row['sch_id']; ?>'" class="btn col-md-12 btn-light" style="border-radius:20px;">Make Appinment</button>
              </form>
            </div>
          </div>
         <?php }
