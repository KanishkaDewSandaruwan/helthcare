      ...
      <?php } ?>
			...
			<div class="row mt-2">
              ...
              $email = $_SESSION['email'];
                    $viewquery = " SELECT * FROM appinment join schedule on schedule.sch_id = appinment.sch_id join doctor on doctor.did = schedule.docid where patient_email = '".$email."'";
                    $viewresult = mysqli_query($con,$viewquery);

                    echo '
                    <div style="margin-top:0.1%;" class="view_div">
                    <a style="text-decoration: none; color :white;" href="dashboard.php?id=2"><h1 class="student_h1"> Your Channeling Details </h1></br></a>



                    <table style="width : 100%; text-align: center;" class="student_table_new"> 
                      <tr>
                        <th style="width : 15%"> Appinment Code </th>
                        <th style="width : 20%"> Doctor </th>
                        <th style="width : 20%"> Description </th>
                        <th style="width : 20%"> Date</th>
                        <th style="width : 10%"> Time </th>
                        <th style="width : 10%"> Appinted Date </th>
